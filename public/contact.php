...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Using a domain-consistent From address helps with deliverability
    $from_email = "noreply@lightslategray-dunlin-761537.hostingersite.com";
    $email_headers = "From: Tryfecta Webform <$from_email>\r\n";
    $email_headers .= "Reply-To: $name <$email>\r\n";
    $email_headers .= "X-Mailer: PHP/" . phpversion();

    // LOGGING: Save a copy to a local file for verification (since email access is limited)
